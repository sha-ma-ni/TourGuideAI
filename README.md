### *Projekt*
**"TourGuideAI"** ist ein Retrieval Augmented Generation (RAG) Projekt zur Ünterstützung von Touristen bei der Planung ihrer Reise in Brandenburg. Es kombiniert die Leistungsfähigkeit von Large Language Models (LLMs) mit einer Wissensdatenbank, um personalisierte und informative Antworten auf Fragen zu Sehenswürdigkeiten, Öffnungszeiten, Eintrittspreisen und mehr zu liefern.
...
### *Datenquellen*
Die offizielle Webseite von Museen und Sehenswürdigkeiten in Brandenburg urheberrechtlich geschützt sind.
